...
export default function NotificationDetail() {
  ...
  return (
    <Screen>
      <View style={styles.header}><Pressable onPress={() => router.back()} style={[styles.iconButton, { backgroundColor: colors.card }]}><Feather name="arrow-left" size={20} color={colors.foreground} /></Pressable><Text style={[styles.headerTitle, { color: colors.foreground }]}>Notification</Text><Pressable onPress={() => toggleFlag(notification.id)} style={[styles.iconButton, { backgroundColor: colors.card }]}><Feather name="star" size={19} color={notification.isFlagged ? colors.accent : colors.mutedForeground} /></Pressable></View>
